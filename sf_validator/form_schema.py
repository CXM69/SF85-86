...
SECTION_SCHEMAS: Dict[str, SectionSchema] = {
    ...
    "15": _schema(
        ...
        ("your military history", "ever served", "branch of service", "military record", "discharge"),
        expected_fields=("branch of service", "dates", "type of discharge"),
        field_label_anchors=("ever served", "branch of service", "from", "to", "service number", "type of discharge"),
        blank_review_enabled=True,
        entry_based=True,
        review_protocol="Military History Review",
        completeness_protocol="Military History Completeness Review",
    ),
